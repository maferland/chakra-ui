...
- [#7882](https://github.com/chakra-ui/chakra-ui/pull/7882)
  ...
  absolute aligns realtive to the outer container element. Hence, the position
  of immediate parent(tabs) is set to relative in this fix.This makes sure, if
  the orientation changes the tab indicator is aligned relative to its parent.
